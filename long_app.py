...
# Set your color
background_color = "#f0f0f0"  # Change this to any color you like
...
t1, t2 = st.columns((0.37,1)) 

t1.image('images/index.png', width = 120)
t2.title("This is Stelios version of - > South Western Ambulance Service - Hospital Handover Report")
...
with st.spinner('Updating Report...'):
    ...
    #m1.title('ok')
    m1.write('')
    #m1.metric(label ='Total Outstanding Handovers',value = int(to['Value']), delta = str(int(to['Previous']))+' Compared to 1 hour ago', delta_color = 'inverse')
    ...
    m4.metric(label = 'Time Lost today (Above 15 mins)',value = str(int(hl['Value']))+" Hours", delta = str(int(hl['Previous']))+' Compared to yesterday')#,  delta_color = 'inverse')
    m1.write('')
    ...
    # in the above you link with the worksheet, Excel !!
    ...
    #fig.update_layout(title_text="Current Waiting Handovers",title_font_color = blue,title_x=0,margin= dict(l=0,r=10,b=10,t=30), height=480)                                                           
...
# https://www.pythonanywhere.com/forums/topic/30697/
# https://medium.com/@whyamit101/streamlit-background-color-guide-f7dbb0df0e75
